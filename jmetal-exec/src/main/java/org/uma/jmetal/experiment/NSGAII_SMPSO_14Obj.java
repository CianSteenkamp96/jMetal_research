...
public class NSGAII_SMPSO_14Obj {
...
//		String experimentBaseDirectory = "/home/cian/IdeaProjects/jMetal/jmetal-exec/src/main/java/org/uma/jmetal/experiment/";
		...
		problemList.add(new ExperimentProblem<>(new WFG1(26, 4, 14)));
		problemList.add(new ExperimentProblem<>(new WFG2(26, 4, 14)));
		problemList.add(new ExperimentProblem<>(new WFG3(26, 4, 14)));
		problemList.add(new ExperimentProblem<>(new WFG4(26, 4, 14)));
		problemList.add(new ExperimentProblem<>(new WFG5(26, 4, 14)));
		problemList.add(new ExperimentProblem<>(new WFG6(26, 4, 14)));
		problemList.add(new ExperimentProblem<>(new WFG7(26, 4, 14)));
		problemList.add(new ExperimentProblem<>(new WFG8(26, 4, 14)));
		problemList.add(new ExperimentProblem<>(new WFG9(26, 4, 14)));

		List<ExperimentAlgorithm<DoubleSolution, List<DoubleSolution>>> algorithmList =
			configureAlgorithmList(problemList);

		Experiment<DoubleSolution, List<DoubleSolution>> experiment =
			new ExperimentBuilder<DoubleSolution, List<DoubleSolution>>("NSGAII_SMPSO_14Obj")
				.setAlgorithmList(algorithmList)
				.setProblemList(problemList)
//				.setReferenceFrontDirectory("/home/cian/IdeaProjects/jMetal/jmetal-algorithm/target/test-classes/referenceFronts/wfg14Obj")
				.setReferenceFrontDirectory("/home/csteenkamp/lustre/msc_phd/jmetal/smpso_nsgaii/referenceFronts/wfg14Obj")
