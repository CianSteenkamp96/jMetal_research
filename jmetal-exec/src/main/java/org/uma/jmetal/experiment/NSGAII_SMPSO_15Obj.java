...
public class NSGAII_SMPSO_15Obj {
...
//			new ExperimentBuilder<DoubleSolution, List<DoubleSolution>>("NSGAII_SMPSO_15Obj_WFG1")
//			new ExperimentBuilder<DoubleSolution, List<DoubleSolution>>("NSGAII_SMPSO_15Obj_WFG2")
//			new ExperimentBuilder<DoubleSolution, List<DoubleSolution>>("NSGAII_SMPSO_15Obj_WFG3")
//			new ExperimentBuilder<DoubleSolution, List<DoubleSolution>>("NSGAII_SMPSO_15Obj_WFG4")
//			new ExperimentBuilder<DoubleSolution, List<DoubleSolution>>("NSGAII_SMPSO_15Obj_WFG5")
//			new ExperimentBuilder<DoubleSolution, List<DoubleSolution>>("NSGAII_SMPSO_15Obj_WFG6")
//			new ExperimentBuilder<DoubleSolution, List<DoubleSolution>>("NSGAII_SMPSO_15Obj_WFG7")
//			new ExperimentBuilder<DoubleSolution, List<DoubleSolution>>("NSGAII_SMPSO_15Obj_WFG8")
			new ExperimentBuilder<DoubleSolution, List<DoubleSolution>>("NSGAII_SMPSO_15Obj_WFG9")
				.setAlgorithmList(algorithmList)
				.setProblemList(problemList)
//				.setReferenceFrontDirectory("/home/cian/IdeaProjects/jMetal/jmetal-algorithm/target/test-classes/referenceFronts/wfg15Obj")
