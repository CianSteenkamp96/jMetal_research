...
public class NSGAII_SMPSO_12Obj {
...
//		String experimentBaseDirectory = "/home/cian/IdeaProjects/jMetal/jmetal-exec/src/main/java/org/uma/jmetal/experiment/";
		...
		problemList.add(new ExperimentProblem<>(new WFG1(22, 4, 12)));
		problemList.add(new ExperimentProblem<>(new WFG2(22, 4, 12)));
		problemList.add(new ExperimentProblem<>(new WFG3(22, 4, 12)));
		problemList.add(new ExperimentProblem<>(new WFG4(22, 4, 12)));
		problemList.add(new ExperimentProblem<>(new WFG5(22, 4, 12)));
		problemList.add(new ExperimentProblem<>(new WFG6(22, 4, 12)));
		problemList.add(new ExperimentProblem<>(new WFG7(22, 4, 12)));
		problemList.add(new ExperimentProblem<>(new WFG8(22, 4, 12)));
		problemList.add(new ExperimentProblem<>(new WFG9(22, 4, 12)));

		List<ExperimentAlgorithm<DoubleSolution, List<DoubleSolution>>> algorithmList =
			configureAlgorithmList(problemList);

		Experiment<DoubleSolution, List<DoubleSolution>> experiment =
			new ExperimentBuilder<DoubleSolution, List<DoubleSolution>>("NSGAII_SMPSO_12Obj")
				.setAlgorithmList(algorithmList)
				.setProblemList(problemList)
//				.setReferenceFrontDirectory("/home/cian/IdeaProjects/jMetal/jmetal-algorithm/target/test-classes/referenceFronts/wfg12Obj")
				.setReferenceFrontDirectory("/home/csteenkamp/lustre/msc_phd/jmetal/smpso_nsgaii/referenceFronts/wfg12Obj")
